...
const FleetDashboard = () => {
  ...
  return (
    <div className="grid grid-rows-[10px_1fr_10px] items-center justify-items-center min-h-screen p-8 pt-4 pb-20 gap-8 sm:p-20 sm:pt-10 font-[family-name:var(--font-geist-sans)]">
